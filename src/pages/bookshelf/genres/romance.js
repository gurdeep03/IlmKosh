...
const Romance = () => {
  ...
  useEffect(() => {
    const fetchBooks = async () => {
      try {
        const response = await axios.get(`https://www.googleapis.com/books/v1/volumes?q=romance&key=AIzaSyA6SaT23KNiiA6DnUfUQTvFeyAcQEkwnSU&maxResults=40`);
  ...
  return (
    <div className='Main'>
      ...
      <h1 style={{ fontFamily: "Italianno, system-ui",color:"#D8C3A5",fontWeight:"550",fontSize:"50px",textAlign:"center"}}>Romantic Books</h1>
